            ...
            <div class="w-5/6">
                <div class="grid gap-4">
                    ...
                    <div class="mb-12 mt-8">
                        ...
                        <p class="mt-2">dgbfgbbfdvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
                            vvdvdsssssssssssssssssssssssssssssssssssssxcccvvvvvvvvvvvvvvv</p>
                    </div>
                </div>
            </div>
            <div class="w-3/4">
                ...
                <div class="flex ml-5 mt-2 justify-between">
                    <div class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-violet-600 my-auto"
                ...
                <div class="flex ml-5 mt-2 justify-between">
                    <div class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-violet-600" viewBox="0 0 24 24" fill="none" 
                ...
                <div class="flex ml-5 mt-2 justify-between">
                    ...
                    <p class="pr-1">Приватний власник</p>
                </div>
                <hr class="ml-5 mt-3 mb-3">
